  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center text-center max-w-lg w-full space-y-6">
        ...
        <div className="flex items-center gap-2 font-mono text-[10px] text-[#8e9192] uppercase tracking-[0.3em]">
          <span className="w-2 h-2 bg-[#e9c349] rounded-full animate-ping" />
          <span>CLASSIFIED INVITATION PROTOCOL</span>
        </div>

        {/* Primary Ultra-Minimalist High-End Tactical Button */}
        <button
          type="button"
        ...
        <p className="font-mono text-[9px] text-[#8e9192] uppercase tracking-[0.3em] opacity-70">
          [ SECURE_TERMINAL_V2.06 // ENCRYPTED_CHANNEL ]
        </p>
      </div>
    </div>
  );
